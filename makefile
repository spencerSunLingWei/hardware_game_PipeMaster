...
# Files
HDRS		:=
SRCS		:= mainnnnnnnnnnn.c draw.c
OBJS		:= $(patsubst %, %.o, $(SRCS))

# Targets
compile: mainnnnnnnnnnn.srec

mainnnnnnnnnnn.srec: mainnnnnnnnnnn.axf
	$(RM) $@
	$(OC) $(OCFLAGS) $< $@

mainnnnnnnnnnn.axf: $(OBJS)
	$(RM) $@
	$(CC) $(LDFLAGS) $(OBJS) -o $@
...
clean:
	$(RM) mainnnnnnnnnnn.srec mainnnnnnnnnnn.axf $(OBJS)
